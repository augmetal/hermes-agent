...
class AIAgent:
    ...
    def __init__(
        ...
        _api_mode_explicit = api_mode in {"chat_completions", "codex_responses", "anthropic_messages"}
        if _api_mode_explicit:
        ...
        # Skip the override when api_mode was explicitly set via config/custom_providers.
        if self.api_mode == "chat_completions" and self._is_direct_openai_url() and not _api_mode_explicit:
            self.api_mode = "codex_responses"
